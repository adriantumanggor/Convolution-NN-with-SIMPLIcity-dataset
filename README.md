...
- **Preprocessing**:
  - Resize + padding:
    - Landscape (width > height): resize → 224 × 150, lalu pad 37 px atas & 37 px bawah → 224 × 224.
    - Portrait (height > width): resize → 150 × 224, lalu pad 37 px kiri & 37 px kanan → 224 × 224.
